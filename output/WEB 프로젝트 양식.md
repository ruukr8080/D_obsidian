...
| **목표!** |  |  
| --- | --- |  
| 1.학습한 내용을 토대로 구현해보며 기본기를 탄탄하게 하자!   2.팀원들과 최대한 소통하며 즐거운 분위기에서 열심히 하자!   3.실제 배포를 목표로 유저의 편의성을 고려하자! |  |  
...
**\-**솔직히 이거 전문가가 해야한다. 신뢰성, 확장성,유지보수성을 모두 고려하며 클린 아키텍처를 설계하는건 내게는 멀고도 험하다. 당장은 기초적인 설계와 아키텍처 설계를 읽는 것에 최선을 다하자.....  
  
**(아키텍처 설계 예시)**  
  
[##_Image|kage@bA9D78/btshAwuWXxS/C8nysYhAhaKpNl7e8WKBKk/img.png|CDM|1.3|{"originWidth":777,"originHeight":597,"style":"alignCenter"}_##]  
...
(만일 팀원이 적거나 할 일이 많으면 그냥 앱의 주요 기능에 맞게 클래스 다이어그램,시퀀스 다이어그램 정도만 고려해도 될 것 같다.. )  
  
꿀팁:인텔리제이에는 클래스 다이어그램과 orm다이어그램 의 설계,관리 기능이 있다.   
...
근데 대규모프로젝트가 아니면 보통 PM이랑 개발자 둘이 다 함  
